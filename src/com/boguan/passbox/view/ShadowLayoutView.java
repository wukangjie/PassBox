...
/**
 * Created by wukangjie on 2016/12/23.
 */
...
public class ShadowLayoutView extends FrameLayout {
    ...
    public ShadowLayoutView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public ShadowLayoutView(Context context, AttributeSet attrs, int defStyleAttr) {
