...
import com.ccst.kuaipan.protocol.exception.KuaipanServerException;
import com.ccst.kuaipan.tool.Base64Utility;
...
public class OauthUtility {	
	 ...
	 * @return
	 */
	public static String encodeParameters(Map<String, String> signed_params) {
	...
	public static String generateSignature(String method, String host, String location, 
	...
	public static Map<String, Object> parseResponseToMap(KuaipanHTTPResponse resp) 
